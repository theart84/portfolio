...
$header .= "From: Новая заявка <artshadow74@gmail.com>\n\n";	
$mail = mail("artshadow74@gmail.com", $subject1, iconv ('utf-8', 'windows-1251', $message1), iconv ('utf-8', 'windows-1251', $header));
